export const site = {
  ...
  /** Post-age-gate membership capture — edit here to update live chrome */
  memberCapture: {
    eyebrow: "Members",
    heading: "Welcome to The Protocol",
    firstRate: "15%",
    memberRate: "10%",
    offerLine: "first dispatch",
    afterLine: "member rate after that",
    body: "Documented materials, packed here, and sent on local express. Your code stays bound to this email.",
    chips: ["Batch COA", "Express dispatch", "≥99% purity target"],
    emailLabel: "Email",
    submitLabel: "Get my member code",
    finePrint: "Applied at checkout. No spam. Unsubscribe anytime.",
    ...
    closeLabel: "Close",
    step2Eyebrow: "One last step",
    step2Heading: "Create a password",
    step2Body:
      "Create a password so the member rate applies automatically at checkout. Benefits lock to",
    passwordLabel: "Password",
    createAccountLabel: "Create account",
    skipLabel: "Skip — set up at checkout",
    hiddenPaths: ["/terms", "/disclaimer", "/privacy", "/checkout"],
  },
  nav: [
